...
int main(int argc, char* argv[]) {
	...
	//per-title key
	const byte TitleSignatureKey[] = { 0x2A, 0xE2, 0x71, 0x3D, 0xD4, 0xA3, 0x4A, 0xE3, 0xF2, 0x0C, 0x29, 0xCD, 0x85, 0x1D, 0xD3, 0x27 };
	...
	//title specific file size check
	signature_offset = (file_size - 0x18);
	signature_area_start = 0;
	signature_area_size = *(u32*)(file_buffer + (file_size - 4));
