...
#define OPTIONS_FILE_SIZE 0x20000
#define PLAYER_FILE_SIZE 0x4000

int main(int argc, char* argv[]) {

	//per-title key
	const byte TitleSignatureKey[] = { 0xEC, 0x19, 0x81, 0x16, 0x7F, 0x15, 0xAC, 0xB9, 0xFE, 0xAD, 0x8A, 0xB6, 0x7A, 0x02, 0xC1, 0xA5 };
	...
	if (file_size != OPTIONS_FILE_SIZE && file_size != PLAYER_FILE_SIZE) {
