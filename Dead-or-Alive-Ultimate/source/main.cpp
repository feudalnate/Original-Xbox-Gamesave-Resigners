...
//checks and markers
#define DOASAVE_FILE 0x5C4
#define UPS_FILE 0x12148
#define BR_FILE 0x81D58
...
int main(int argc, char* argv[]) {
	...
	const byte TitleSignatureKey[] = { 
		0x42, 0xCB, 0xF5, 0x32, 0xBF, 0x1F, 0xD1, 0x47, 0x39, 0xD0, 0xF7, 0xF6, 0x6D, 0xF8, 0xB7, 0xB1
	};
	...
	if (file_size != DOASAVE_FILE && file_size != UPS_FILE && file_size != BR_FILE) {
	...
	signature_type = ((file_size == UPS_FILE) ? XCALCSIG_FLAG_NON_ROAMABLE : XCALCSIG_FLAG_SAVE_GAME);
	signature_offset = 0;
