...
#define PROFILE_FILE_SIZE 0x264C
...
int main(int argc, char* argv[]) {
	...
	const byte TitleSignatureKey[] = { 
		0x61, 0x67, 0x6F, 0x08, 0xB3, 0x1D, 0x71, 0xDC, 0xF8, 0xE0, 0x29, 0x03, 0xCB, 0x51, 0x64, 0xBB
	};
	...
	if (file_size != SINGLE_MULTI_SAV_FILE_SIZE && file_size != SINGLE_MULTI_IMAGE_FILE_SIZE && file_size != PROFILE_FILE_SIZE) {
